...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: async ({ params }) => fetch(`https://cooking-server-rahad23.vercel.app/food/${params.id}`)
            },
            {
                path: '/register',
            ...
            },
            {
                ...
                loader: async ({ params }) => fetch(`https://cooking-server-rahad23.vercel.app/commentUpdate/${params.id}`)
            },
            {
                path: '/service',
                element: <AllCategoryPage></AllCategoryPage>
